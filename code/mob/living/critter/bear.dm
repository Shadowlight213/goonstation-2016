...
/mob/living/critter/bear/specific_emotes(var/act, var/param = null, var/voluntary = 0)
	switch (act)
		if ("scream")
...
/mob/living/critter/bear/specific_emote_type(var/act)
	switch (act)
		if ("scream")
			return 2
	return ..()

/mob/living/critter/bear/setup_equipment_slots()
	equipment += new /datum/equipmentHolder/suit(src)
	equipment += new /datum/equipmentHolder/ears(src)
	equipment += new /datum/equipmentHolder/head(src)

/mob/living/critter/bear/setup_hands()
	..()
...
/mob/living/critter/bear/setup_healths()
