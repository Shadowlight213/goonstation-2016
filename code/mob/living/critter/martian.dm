...
/mob/living/critter/martian/understands_language(var/langname)
	if (langname == say_language || langname == "martian")
		return 1
	return 0

/mob/living/critter/martian/setup_equipment_slots()
	equipment += new /datum/equipmentHolder/ears(src)
	equipment += new /datum/equipmentHolder/head(src)

/mob/living/critter/martian/setup_hands()
	..()
	var/datum/handHolder/HH = hands[1]
	HH.name = "tentacles"

/mob/living/critter/martian/setup_healths()
...
/mob/living/critter/martian/New()
	..()
...
/mob/living/critter/martian/say(message, involuntary = 0)
...
/mob/living/critter/martian/warrior/setup_hands()
	..()
	var/datum/handHolder/HH = hands[1]
	HH.icon_state = "handl"
...
/mob/living/critter/martian/soldier/setup_hands()
	..()
...
/mob/living/critter/martian/mutant/New()
	..()
