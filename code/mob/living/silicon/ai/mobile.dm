...
/mob/living/silicon/ai/mobile/New()
	..()
...
/mob/living/silicon/ai/mobile/Login()
	..()
	if (src.stat != 2)
		src.set_face()
	return

/mob/living/silicon/ai/mobile/Logout()
...
/mob/living/silicon/ai/mobile/attack_ai(mob/user as mob)
...
/mob/living/silicon/ai/mobile/Bump(atom/movable/AM as mob|obj, yes)
...
/mob/living/silicon/ai/mobile/Life(datum/controller/process/mobs/parent)
	if (..(parent))
		return 1
...
/mob/living/silicon/ai/mobile/set_face(var/emotion)
	src.overlays.len = 0
...
/mob/living/silicon/ai/mobile/proc/check_power()
	if(src.cell)
...
/mob/living/silicon/hivebot/drone/New()
	..()
	spawn(6)
		var/obj/overlay/U1 = new
		U1.icon = src.icon
...
/mob/living/silicon/hivebot/drone/attack_ai(mob/user as mob)
	if(!isAI(user))
		return
...
/mob/living/silicon/hivebot/drone/return_mainframe()
...
/mob/living/silicon/hivebot/drone/Bump(atom/movable/AM as mob|obj, yes)
	if ((!( yes ) || src.now_pushing))
		return
	src.now_pushing = 1
