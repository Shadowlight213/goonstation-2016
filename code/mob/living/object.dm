...
/mob/living/object/New(var/atom/loc as mob|obj|turf, var/mob/controller)
	..()
...
/mob/living/object/equipped()
	if (canattack)
		return src.item
	else
		return src.dummy

/mob/living/object/examine()
	..()
...
/mob/living/object/meteorhit(var/obj/O as obj)
	src.death(1)
	return

/mob/living/object/restrained()
	return 0

/mob/living/object/updatehealth()
	return
...
/mob/living/object/bullet_act(var/obj/projectile/P)
	var/damage = 0
...
/mob/living/object/attack_hand(mob/user as mob)
...
/mob/living/object/TakeDamage(zone, brute, burn)
	health -= burn
	health -= brute
...
/mob/living/object/HealDamage(zone, brute, burn)
	TakeDamage(zone, -brute, -burn)

/mob/living/object/change_eye_blurry(var/amount, var/cap = 0)
	if (amount < 0)
		return ..()
	else
		return 1

/mob/living/object/take_eye_damage(var/amount, var/tempblind = 0)
	if (amount < 0)
		return ..()
	else
		return 1

/mob/living/object/take_ear_damage(var/amount, var/tempdeaf = 0)
	if (amount < 0)
		return ..()
	else
		return 1

/mob/living/object/click(atom/target, params)
	if (target == src)
		if (canattack)
...
/mob/living/object/death(gibbed)
	if (src.owner)
...
/mob/living/object/movement_delay()
	return 4

/mob/living/object/put_in_hand(obj/item/I, hand)
	return 0

/mob/living/object/swap_hand()
	return 0

/mob/living/object/drop_item_v()
	return 0

/mob/living/object/item_attack_message(var/mob/T, var/obj/item/S, var/d_zone)
	if (d_zone)
