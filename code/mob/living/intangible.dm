...
/mob/living/intangible/can_strip()
	return 0
/mob/living/intangible/can_use_hands()
	return 0
/mob/living/intangible/is_active()
	return 0
/mob/living/intangible/say_understands(var/other)
	return 1
/mob/living/intangible/CanPass(atom/movable/mover, turf/target, height=0, air_group=0)
	return 1

/mob/living/intangible/meteorhit()
	return

// No log entries for unaffected mobs (Convair880).
/mob/living/intangible/ex_act(severity)
	return

/mob/living/intangible/Move(NewLoc, direct)
	if(!canmove) return
