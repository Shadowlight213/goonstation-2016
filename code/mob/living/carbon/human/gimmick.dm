...
/mob/living/carbon/human/cluwne/New()
	..()
	spawn(0)
		src.gender = "male"
...
/mob/living/carbon/human/cluwne/Life(datum/controller/process/mobs/parent)
	if (..(parent))
		return 1
	if (stat == 2)
		return
...
/mob/living/carbon/human/cluwne/floor/New()
	..()
	spawn(0)
		ailments.Cut()
...
/mob/living/carbon/human/cluwne/floor/cluwnegib()
	return

/mob/living/carbon/human/cluwne/floor/ex_act()
	return
...
/mob/living/carbon/human/fatherted/New()
	..()
	spawn(0)
...
/mob/living/carbon/human/fatherjack/New()
	..()
	spawn(0)
		bioHolder.mobAppearance.gender = "male"
...
/mob/living/carbon/human/fatherjack/Life(datum/controller/process/mobs/parent)
	if (..(parent))
		return 1
...
/mob/living/carbon/human/fatherjack/attack_hand(mob/M)
	..()
...
/mob/living/carbon/human/fatherjack/attackby(obj/item/W, mob/M)
...
/mob/living/carbon/human/biker/New()
	..()
	spawn(0)
...
/mob/living/carbon/human/biker/Life(datum/controller/process/mobs/parent)
	if (..(parent))
		return 1
	if(!src.stat)
		if(target)
...
/mob/living/carbon/human/biker/attack_hand(mob/M)
	..()
	if (M.a_intent in list(INTENT_HARM,INTENT_DISARM,INTENT_GRAB))
		for (var/mob/living/carbon/human/npc/diner_bartender/BT in all_viewers(7, src))
			BT.protect_from(M, src)

/mob/living/carbon/human/biker/attackby(obj/item/W, mob/M)
	var/tmp/oldbloss = get_brute_damage()
	var/tmp/oldfloss = get_burn_damage()
	..()
	var/tmp/damage = ((get_brute_damage() - oldbloss) + (get_burn_damage() - oldfloss))
...
/mob/living/carbon/human/merchant/New()
	..()
	spawn(0)
		src.gender = "male"
...
/mob/living/carbon/human/myke/New()
	..()
	spawn(0)
		src.gender = "male"
		src.real_name = "Myke"
...
/mob/living/carbon/human/myke/Life(datum/controller/process/mobs/parent)
	if (..(parent))
		return 1
	src.weakened = 5
	if(prob(15))
...
/mob/living/carbon/human/waldo/New()
	..()
	spawn(0)
		src.gender = "male"
		src.real_name = "Waldo"
...
/mob/living/carbon/human/fake_waldo
	nodamage = 1
/mob/living/carbon/human/fake_waldo/New()
	..()
	spawn(0)
		src.gender = "male"
		...
		sleep(rand(150, 600))
		illusion_expire()
/mob/living/carbon/human/fake_waldo/Life(datum/controller/process/mobs/parent)
	if (..(parent))
		return 1
	if(prob(33) && canmove && isturf(loc))
		step(src, pick(cardinal))
/mob/living/carbon/human/fake_waldo/proc/illusion_expire(mob/user)
	if(user)
	...
	spawn(0)
		qdel(src)
	return
/mob/living/carbon/human/fake_waldo/attack_hand(mob/user)
	return illusion_expire(user)
/mob/living/carbon/human/fake_waldo/attackby(obj/item/W, mob/user)
	return illusion_expire(user)
/mob/living/carbon/human/fake_waldo/MouseDrop(mob/M)
...
/mob/living/carbon/human/don_glab/New()
	..()
	spawn(0)
		bioHolder.age = 44
...
/mob/living/carbon/human/don_glab/attack_hand(mob/M)
	..()
	if (M.a_intent in list(INTENT_HARM,INTENT_DISARM,INTENT_GRAB))
		for (var/mob/living/carbon/human/npc/diner_bartender/BT in all_viewers(7, src))
			BT.protect_from(M, src)

/mob/living/carbon/human/don_glab/attackby(obj/item/W, mob/M)
	var/tmp/oldbloss = get_brute_damage()
	var/tmp/oldfloss = get_burn_damage()
	..()
	var/tmp/damage = ((get_brute_damage() - oldbloss) + (get_burn_damage() - oldfloss))
...
/mob/living/carbon/human/tommy/New()
	..()
	spawn(0)
