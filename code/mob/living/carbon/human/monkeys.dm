...
/mob/living/carbon/human/npc/monkey/mr_muggles
	...
	gender = "male"
/mob/living/carbon/human/npc/monkey/mr_muggles/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/mrs_muggles
	...
	gender = "female"
/mob/living/carbon/human/npc/monkey/mrs_muggles/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/mr_rathen
	...
	real_name = "Mr. Rathen"
	gender = "male"
/mob/living/carbon/human/npc/monkey/mr_rathen/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/albert
	...
	real_name = "Albert"
	gender = "male"
/mob/living/carbon/human/npc/monkey/albert/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/von_braun
	...
	real_name = "Von Braun"
	gender = "male"
/mob/living/carbon/human/npc/monkey/von_braun/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/horse
	...
	real_name = "????"
	gender = "male"
/mob/living/carbon/human/npc/monkey/horse/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/tanhony
	...
	real_name = "Tanhony"
	gender = "female"
/mob/living/carbon/human/npc/monkey/tanhony/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/krimpus
	...
	real_name = "Krimpus"
	gender = "female"
/mob/living/carbon/human/npc/monkey/krimpus/New()
	..()
	spawn(10)
...
/mob/living/carbon/human/npc/monkey/New()
	..()
	spawn(5)
		if (!src.disposed)
...
/mob/living/carbon/human/npc/monkey/ai_action()
	if(ai_aggressive)
		return ..()
...
/mob/living/carbon/human/npc/monkey/ai_findtarget_new()
	if (ai_aggressive || ai_aggression_timeout == 0 || (world.timeofday - ai_threatened) < ai_aggression_timeout)
		..()

/mob/living/carbon/human/npc/monkey/was_harmed(var/mob/M as mob, var/obj/item/weapon as obj)
	//src.ai_aggressive = 1
	src.target = M
	src.ai_state = 2
...
/mob/living/carbon/human/npc/monkey/proc/done_with_you(var/mob/M as mob)
	if (!M)
		return 0
	if (src.health <= 0)
		src.target = null
...
/mob/living/carbon/human/npc/monkey/proc/ai_pickpocket()
...
/mob/living/carbon/human/npc/monkey/proc/ai_knock_from_hand()
...
/datum/action/bar/icon/filthyPickpocket/New(var/Source, var/Target, var/Slot)
	source = Source
	target = Target
	slot = Slot
...
/datum/action/bar/icon/filthyPickpocket/onStart()
	..()
...
/datum/action/bar/icon/filthyPickpocket/onEnd()
	..()
...
/datum/action/bar/icon/filthyPickpocket/onUpdate()
	..()
	if(get_dist(source, target) > 1 || target == null || source == null)
		interrupt(INTERRUPT_ALWAYS)
		return
...
/datum/action/bar/icon/filthyPickpocket/onInterrupt()
	..()
	source.ai_picking_pocket = 0
