...
/mob/living/carbon/human/glitchy/New()
	..()
	spawn(0)
		src.rename_self()
...
/mob/living/carbon/human/glitchy/Life(datum/controller/process/mobs/parent)
	if (..(parent))
		return 1
...
/mob/living/carbon/human/glitchy/Bump(atom/movable/AM, yes)
	..()
	src.glitch_up(AM)

/mob/living/carbon/human/glitchy/get_age_pitch()
	..()
	return 1.0 + 0.5*(30 - rand(1,120))/80

/mob/living/carbon/human/glitchy/proc/rename_self()
...
/mob/living/carbon/human/glitchy/proc/glitch_up(var/atom/A)
	if (!A || !A.icon)
		return
