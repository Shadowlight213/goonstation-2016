...
/mob/living/carbon/wall/examine()
	set src in view()
...
/mob/living/carbon/wall/say_understands(var/other)
	if (ishuman(other) || isrobot(other) || isAI(other))
		return 1
	return ..()

/mob/living/carbon/wall/attack_hand(mob/user as mob)
...
/mob/living/carbon/wall/ex_act(severity)
	..() // Logs.
	switch(severity)
		if(1.0)
			src.gib(1)
...
/mob/living/carbon/wall/attackby(obj/item/W as obj, mob/user as mob)
...
/mob/living/carbon/wall/meatcube/krampus/New()
	..()
...
/mob/living/carbon/wall/meatcube/krampus/attackby(obj/item/W as obj, mob/user as mob)
