...
/obj/ability_button/extinguisher_ab/execute_ability()
...
/obj/ability_button/extinguisher_ab/OnDrop()
...
/obj/ability_button/mask_toggle/execute_ability()
...
/obj/ability_button/tank_valve_toggle/OnDrop() // since tanks close when dropped this should always start off
	icon_state = "airoff"
	..()

/obj/ability_button/tank_valve_toggle/execute_ability()
...
/obj/ability_button/shoerocket/Click()
...
/obj/ability_button/flashlight_toggle/execute_ability()
...
/obj/ability_button/flashlight_engiehelm/execute_ability()
...
/obj/ability_button/flashlight_hardhat/execute_ability()
...
/obj/ability_button/tscanner_toggle/execute_ability()
...
/obj/ability_button/jetpack_toggle/execute_ability()
...
/obj/item/proc/clear_mob()
	for(var/obj/ability_button/B in ability_buttons)
		B.the_mob = null
	the_mob = null

/obj/item/proc/set_mob(var/mob/M)
	if(!M) return
	for(var/obj/ability_button/B in ability_buttons)
		B.the_mob = M
	the_mob = M

/obj/item/proc/show_buttons()
...
/obj/item/proc/hide_buttons()
	if(!the_mob) return
	the_mob.item_abilities.Remove(ability_buttons)
	the_mob.need_update_item_abilities = 1
	the_mob.update_item_abilities()
/*
/obj/item/proc/check_abilities()
	if (!(src in heh))
		heh += src
...
/obj/ability_button/Click()
	if(ability_allowed())
		execute_ability()

/obj/ability_button/attackby()
	return

/obj/ability_button/attack_hand()
	return

	//WIRE TOOLTIPS
/obj/ability_button/MouseEntered(location, control, params)
	usr.client.tooltip.show(src, params, title = src.name, content = (src.desc ? src.desc : null))

/obj/ability_button/MouseExited()
	usr.client.tooltip.hide()

/obj/ability_button/proc/ability_allowed()
	if (!the_item)
		return 0
...
/obj/ability_button/proc/execute_ability()
	return

/obj/ability_button/proc/OnDrop()
	return
