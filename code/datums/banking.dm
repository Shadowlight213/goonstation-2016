...
/datum/wage_system/proc/timeleft()
...
/datum/wage_system/proc/get_banking_timeleft()
...
/obj/machinery/computer/ATM/attackby(var/obj/item/I as obj, user as mob)
...
/obj/machinery/computer/ATM/attack_ai(var/mob/user as mob)
	return

/obj/machinery/computer/ATM/attack_hand(var/mob/user as mob)
	if(..())
		return
...
/obj/machinery/computer/bank_data/attack_hand(mob/user as mob)
	if(..())
		return
	var/dat
	if (src.temp)
...
/obj/submachine/ATM/attackby(var/obj/item/I as obj, user as mob)
	if (istype(I, /obj/item/device/pda2) && I:ID_card)
		I = I:ID_card
	if(istype(I, /obj/item/card/id))
		boutput(user, "<span style=\"color:blue\">You swipe your ID card in the ATM.</span>")
...
/obj/submachine/ATM/attack_ai(var/mob/user as mob)
	return

/obj/submachine/ATM/attack_hand(var/mob/user as mob)
	if(..())
		return
